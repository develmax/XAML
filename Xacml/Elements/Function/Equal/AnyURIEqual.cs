namespace Xacml.Elements.Function.Equal
{
    ...
    public class AnyURIEqual : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:anyURI-equal";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is AnyURIDataType && @params[1] is AnyURIDataType)
            {
