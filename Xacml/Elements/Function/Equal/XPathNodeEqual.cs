namespace Xacml.Elements.Function.Equal
{
    ...
    public class XPathNodeEqual : XPathHelper
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:xpath-node-equal";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
                ...
                @params[1] is XpathExpressionDataType)
            {
                try
                {
                    ...
                    if (this.IsNodeListMatch(ret1, ret2) && this.IsNodeListMatch(ret2, ret1))
                    {
