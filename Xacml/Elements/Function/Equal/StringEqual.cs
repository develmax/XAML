namespace Xacml.Elements.Function.Equal
{
    ...
    public class StringEqual : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:string-equal";
        ...
        {
            if (@params.Length == paramsnum && (@params[0] == null || @params[1] == null)) return BooleanDataType.False;
