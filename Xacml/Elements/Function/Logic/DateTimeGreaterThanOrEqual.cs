namespace Xacml.Elements.Function.Logic
{
    ...
    public class DateTimeGreaterThanOrEqual : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than-or-equal";
