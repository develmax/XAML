namespace Xacml.Elements.Function.String
{
    ...
    public class StringNormalizeSpace : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:string-normalize-spacen";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            ...
            {
                string res = (@params[0]).Value.Trim();
