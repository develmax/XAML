namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromIpAddress : Function
    {
        internal const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-ipAddress";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is IpAddressDataType)
            {
