namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromAnyURI : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-anyURI";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is AnyURIDataType)
            {
