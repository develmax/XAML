namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromTime : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-time";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is TimeDataType)
            {
