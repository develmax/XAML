namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromDnsName : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-dnsName";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is DnsNameDataType)
            {
