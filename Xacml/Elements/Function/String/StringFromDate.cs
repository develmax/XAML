namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromDate : Function
    {
        internal const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-date";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is DateDataType)
            {
