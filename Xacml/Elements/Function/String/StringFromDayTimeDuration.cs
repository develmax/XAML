namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromDayTimeDuration : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-dayTimeDuration";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is DayTimeDurationDataType)
            {
