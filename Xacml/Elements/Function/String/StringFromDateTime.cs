namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromDateTime : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-dateTime";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is DateTimeDataType)
            {
