namespace Xacml.Elements.Function.String
{
    ...
    public class AnyURIEndsWith : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:anyURI-ends-with";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is StringDataType && @params[1] is AnyURIDataType)
            {
                string arg1 = (@params[0]).Value;
                string arg2 = (@params[1]).Value;
                if (arg2.EndsWith(arg1)) return BooleanDataType.True;
