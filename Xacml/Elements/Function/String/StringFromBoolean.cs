namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromBoolean : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-boolean";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            ...
            {
                return new StringDataType((@params[0]).Value);
            }
