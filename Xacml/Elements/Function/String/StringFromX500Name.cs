namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromX500Name : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-x500Name";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is X500NameDataType)
            {
