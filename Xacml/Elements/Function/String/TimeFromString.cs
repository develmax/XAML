namespace Xacml.Elements.Function.String
{
    ...
    public class TimeFromString : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:time-from-string";
