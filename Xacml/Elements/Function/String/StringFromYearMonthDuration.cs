namespace Xacml.Elements.Function.String
{
    ...
    public class StringFromYearMonthDuration : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-from-yearMonthDuration";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is YearMonthDurationDataType)
            {
