namespace Xacml.Elements.Function.String
{
    ...
    public class AnyURIContains : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:anyURI-contains";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            if (@params.Length == paramsnum && @params[0] is StringDataType && @params[1] is AnyURIDataType)
            {
                ...
                if (arg2.Contains(arg1)) return BooleanDataType.True;
