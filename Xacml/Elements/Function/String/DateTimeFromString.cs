namespace Xacml.Elements.Function.String
{
    ...
    public class DateTimeFromString : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:dateTime-from-string";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            if (@params.Length == paramsnum && @params[0] is StringDataType)
            {
                ...
                try
                {
                    return new DateTimeDataType(res);
                }
