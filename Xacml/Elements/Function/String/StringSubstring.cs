namespace Xacml.Elements.Function.String
{
    ...
    public class StringSubstring : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:string-substring";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is StringDataType && @params[1] is IntegerDataType &&
