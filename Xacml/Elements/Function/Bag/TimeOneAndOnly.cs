namespace Xacml.Elements.Function.Bag
{
    ...
    public class TimeOneAndOnly : OneAndOnly
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:time-one-and-only";
        ...
        {
            return this.Evaluate(@params, ctx, typeof(TimeDataType));
        }
    }
}