namespace Xacml.Elements.Function.Bag
{
    ...
    public class YearMonthDurationOneAndOnly : OneAndOnly
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:yearMonthDuration-one-and-only";
