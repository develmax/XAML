namespace Xacml.Elements.Function.Bag
{
    ...
    public class DayTimeDurationOneAndOnly : OneAndOnly
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:dayTimeDuration-one-and-only";
