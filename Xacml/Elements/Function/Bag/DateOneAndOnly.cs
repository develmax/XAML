namespace Xacml.Elements.Function.Bag
{
    ...
    public class DateOneAndOnly : OneAndOnly
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:date-one-and-only";
        ...
        {
            return this.Evaluate(@params, ctx, typeof(DateDataType));
        }
    }
}