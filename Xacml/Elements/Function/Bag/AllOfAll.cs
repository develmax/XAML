namespace Xacml.Elements.Function.Bag
{
    ...
    public class AllOfAll : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:all-of-all";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            ...
            if (size == paramsnum && (@params[1] is BagDataType) && (@params[2] is BagDataType))
            {
                ...
                {
                    if (this.IsOneOfBag(functionid, (DataTypeValue)children[i], bag2, ctx) == false)
                    {
