namespace Xacml.Elements.Function.Match
{
    ...
    public class DnsNameRegexpMatch : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:2.0:function:dnsName-regexp-match";
        ...
        {
            if (@params.Length == paramsnum && @params[0] is StringDataType && @params[1] is DnsNameDataType)
            {
