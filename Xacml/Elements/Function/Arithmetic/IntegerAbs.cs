namespace Xacml.Elements.Function.Arithmetic
{
    ...
    public class IntegerAbs : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:integer-abs";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            ...
            {
                int res = ((IntegerDataType)@params[0]).Integer;
                res = Math.Abs(res);
