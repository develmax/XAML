namespace Xacml.Elements.Function.Arithmetic
{
    ...
    public class DateTimeAddDayTimeDuration : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:dateTime-add-dayTimeDuration";
