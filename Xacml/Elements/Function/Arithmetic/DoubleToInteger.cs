namespace Xacml.Elements.Function.Arithmetic
{
    ...
    public class DoubleToInteger : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:1.0:function:double-to-integer";
        ...
        public override DataTypeValue Evaluate(DataTypeValue[] @params, EvaluationContext ctx)
        {
            if (@params.Length == paramsnum && @params[0] is DoubleDataType)
            {
                ...
                return new IntegerDataType(Convert.ToString((int)res));
            }
