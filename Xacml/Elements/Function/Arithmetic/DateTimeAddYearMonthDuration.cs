namespace Xacml.Elements.Function.Arithmetic
{
    ...
    public class DateTimeAddYearMonthDuration : Function
    {
        public const string stringIdentifer = "urn:oasis:names:tc:xacml:3.0:function:dateTime-add-yearMonthDuration";
