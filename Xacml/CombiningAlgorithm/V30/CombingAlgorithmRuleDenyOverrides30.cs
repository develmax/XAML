namespace Xacml.CombiningAlgorithm.V30
{
    ...
    public class CombingAlgorithmRuleDenyOverrides30 : ICombiningAlgorithm
    {
        public const string Identifer = "urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:deny-overrides";
