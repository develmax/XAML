namespace Xacml.CombiningAlgorithm.V30
{
    ...
    public class CombingAlgorithmPolicyPermitOverrides30 : ICombiningAlgorithm
    {
        public const string Identifer = "urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:permit-overrides";
