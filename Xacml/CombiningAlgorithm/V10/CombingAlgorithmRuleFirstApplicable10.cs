namespace Xacml.CombiningAlgorithm.V10
{
    ...
    public class CombingAlgorithmRuleFirstApplicable10 : ICombiningAlgorithm
    {
        public const string Identifer = "urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:first-applicable";
